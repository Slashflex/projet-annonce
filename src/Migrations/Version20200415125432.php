 ...
 */
final class Version20200415125432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT NOT NULL, titre VARCHAR(60) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, introduction TEXT DEFAULT NULL, contenu TEXT DEFAULT NULL, image_couverture VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
